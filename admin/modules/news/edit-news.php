<?php 
    ...
    if(($_SERVER['REQUEST_METHOD'] == 'POST')){
      ...
      if($data['title'] && $data['keyword'] && $data['content'] && $data['description'] != NULL){
          ...
          $post= $db->update("news",$data,array("id"=>$id));
...
<div id="main">
         <ol class="breadcrumb">
            ...
            <li class="active"><a href="edit-news.php">Chỉnh sửa bài viết</a></li>
         </ol>
         <div class="col-xs-12">
            ...
            <?php foreach ($post as $value) { ?>
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <input name="title" type="text" value="<?php echo $value['title'] ?>" class="form-control" id="title" placeholder="Tên bài viết ( ~ 70 ký tự )" required="" maxlength="100" >
                  </div>
               </div>
               <div class="form-group">
                  <label for="keyword" class="col-sm-2 control-label">Từ khóa</label>
                  <div class="col-sm-10">
                     <input name="keyword" type="text" value="<?=$value['keyword'] ?>" class="form-control" id="keyword" placeholder="meta keywords" maxlength="255">
                  </div>
               </div>
               <div class="form-group">
                  <label for="description" class="col-sm-2 control-label">Mô tả</label>
                  <div class="col-sm-10">
                     <textarea name="description"  class="form-control" id="description" placeholder="meta description ( ~ 160 ký tự )" maxlength="255"><?php echo $value['description']?></textarea>
                  </div>
               </div>
               <div class="form-group">
                  <label for="content" class="col-sm-2 control-label">Nội dung</label>
                  <div class="col-sm-10">
                       <textarea name="content"  rows="5" class="form-control ckeditor" id="content" placeholder="Nội dung bài viết" ><?php echo $value['content'] ?></textarea>
                   </div>
            <?php } ?>       
                <div class="form-group" >
