...
/*===============================
/bookstore/modules/mod_sp_accordion/js/sp-accordion.js
================================================================================*/;
!(function($){$.fn.spAccordion=function(options){var settings=$.extend({hidefirst:0},options);return this.each(function(){var $items=$(this).find('>div');var $handlers=$items.find('.toggler');var $panels=$items.find('.sp-accordion-container');if(settings.hidefirst===1)
{$panels.hide().first();}
else
{$handlers.first().addClass('active');$panels.hide().first().slideDown();}
$handlers.on('click',function(){if($(this).hasClass('active'))
{$(this).removeClass('active');$panels.slideUp();}
else
{$handlers.removeClass('active');$panels.slideUp();$(this).addClass('active').parent().find('.sp-accordion-container').slideDown();}
event.preventDefault();});});};})(jQuery);


/*===============================
/bookstore/media/system/js/caption.js
================================================================================*/;
